...
{    
    public function dateWiseSalesReport(Request $request, DateWiseSalesReportService $service)
    {
        try {
            $reports = $service->dateWiseSalesReport($request->from_date, $request->to_date);
            $reportData = [
                'reports' => $reports,
