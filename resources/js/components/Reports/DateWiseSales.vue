  ...
  <div class="content-wrapper">
    <div class="row justify-content-md-center" id="printArea">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title text-center">Date Wise Sales Report</h4>
            <hr>
                ...
                <tbody>
                  ...
                  <tbody v-if="reports.length">
                    <tr v-for="(report, index) in reports" :key="index">                        
                      ...
                      <td class="text-center">
                        {{ report.total_product_price + report.total_tax_value }}
                      </td>
                      <td></td>
                    </tr>
  ...
  export default {
    ...
    methods: {
      ...
      getDateWiseSlaesReport() {
        ...
        axios.get('/date-wise-sales-report', { params: {from_date:this.form.from_date, to_date: this.form.to_date}})
          .then(response => {
