...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    store: function store() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/outlets', this.form).then(function (response) {
    ...
    searchOutlets: function searchOutlets() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('search-outlets?search_key=' + this.search_key).then(function (res) {
      ...
      this.$snotify.confirm("Are you sure to delete this?", {
        ...
        buttons: [{
          ...
          action: function action(toast) {
            ...
            _axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]('/outlets/' + id).then(function (response) {
              _this3.getOutlets();
