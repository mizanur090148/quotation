...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    searchVisitSchedules: function searchVisitSchedules() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('search-visit-schedules?search_key=' + this.search_key).then(function (res) {
      ...
      this.$snotify.confirm("Are you sure to delete this?", {
        ...
        buttons: [{
          ...
          action: function action(toast) {
            ...
            _axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]('/visit-schedules/' + id).then(function (response) {
    ...
    getVisitSchedules: function getVisitSchedules() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('visit-schedules?page=' + this.pagination.current_page).then(function (res) {
