(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Milons"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    searchStockIns: function searchStockIns() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('stock-ins?search_key=' + this.search_key).then(function (res) {
        _this.stock_ins = res.data.data;
    ...
    _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('search-stock-ins?search_key=' + this.search_key).then(function (res) {
      _this2.stock_ins = res.data.data;
      _this2.pagination = res.data;
    })["catch"](function (e) {
      console.log(e);
    });
  }), _defineProperty(_methods, "deleteStockIn", function deleteStockIn(stockInId) {
    var _this3 = this;
    ...
    this.$snotify.confirm("Are you sure to delete this?", {
      ...
      buttons: [{
        ...
        action: function action(toast) {
          ...
          _axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]('/stock-ins/' + stockInId).then(function (response) {
            _this3.getStockIns();
  ...
  }), _defineProperty(_methods, "getStockIns", function getStockIns() {
    var _this4 = this;
    ...
    _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('stock-ins?page=' + this.pagination.current_page).then(function (res) {
      _this4.stock_ins = res.data.data;
                      ...
                      ? _c(
                          ...
                          _vm._l(_vm.stock_ins, function(stock_in, index) {
                            return _c("tr", { key: stock_in.id }, [
                              ...
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(stock_in.purchase_date))
                              ]),
                              _vm._v(" "),
                              _c("td", [
