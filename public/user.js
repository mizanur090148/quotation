...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getProductInfo: function getProductInfo(productId) {
      ...
      _apis_Api__WEBPACK_IMPORTED_MODULE_0__["default"].get('users/' + productId).then(function (res) {
        _this.form = res.data;
    ...
    store: function store() {
      ...
      _apis_Api__WEBPACK_IMPORTED_MODULE_0__["default"].post('/users', this.form).then(function (response) {
    ...
    roleDropdowndata: function roleDropdowndata() {
      ...
      _apis_Api__WEBPACK_IMPORTED_MODULE_0__["default"].get('/role-dropdown-data').then(function (res) {
