...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    review: function review() {
      ...
      _apis_Api__WEBPACK_IMPORTED_MODULE_0__["default"].post('/visit-schedules', this.form).then(function (response) {
    ...
    getVisitScheduleInfo: function getVisitScheduleInfo(id) {
      ...
      _apis_Api__WEBPACK_IMPORTED_MODULE_0__["default"].get('visit-schedules/' + id).then(function (res) {
        var range = {
