...
class ScheduleController extends BaseController
{
    ...
    *
    ...
    {
        try {
            $results = Schedule::whereYear('from_date', date('Y'))
                ->whereMonth('from_date', date('m'))
                ->get();
            
            $data = [];
            foreach ($results as $key => $result) {
                $data[$key]['title'] = $result->from_location . ' - ' .  $result->to_location;
                $data[$key]['title'] = $result->form_date;
                $data[$key]['title'] = $result->to_date;
                $data[$key]['title'] = $result->from_location;
            }
