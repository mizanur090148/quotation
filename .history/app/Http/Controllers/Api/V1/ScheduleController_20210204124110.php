    ...
    public function search(Request $request)
    {
        try {
            $modelData = Schedule::where('from_date', 'like', "%$request->search_key")
                ->orWhere('from_date', 'like', "%$request->search_key%")
                ->orWhere('from_location', 'like', "%$request->search_key%")
                ->orWhere('to_location', 'like', "%$request->search_key%")
                ->orWhere('note', 'like', "%$request->search_key%")
                ->paginate();
