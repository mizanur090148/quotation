...
class ScheduleController extends BaseController
{
    ...
    *
    ...
    {       
        try {  
            dd($request->range['start']); 
            $input = $request->only('from_location','to_location','note');
            $request = array_merge($input, ['from_date' => $request->range['start'], 'to_date' => $request->range['start']]);
