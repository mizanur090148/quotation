...
class ScheduleController extends BaseController
{
    ...
    *
    ...
    {       
        try {   
            $request = array_merge($request->all(), ['from_date' => '2021-01-22', 'to_date' => '2021-01-22']);
            $modelData = $this->apiCrudHandler->store(collect(new Illuminate\Http\Request($request), Schedule::class);           
            return $this->sendResponse($modelData);
        } catch (Exception $ex) {
            return $this->sendError($e->getMessage());
        }
