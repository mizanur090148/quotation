            ...
            <form class="forms-sample" @submit.prevent="review()">
              ...
              <div class="row pt-3 pb-3">
                <div class="col-2">
                  <div class="form-group row">
                    <div class="col-sm-3 radio-field">
                      <input type="radio" v-model="form.status" value="1" class=" text-primary form-control form-control-sm radio-field">
                    </div>
                ...
                <div class="col-2">
                  <div class="form-group row">
                    <div class="col-sm-3 radio-field">
                      <input type="radio" v-model="form.status" value="3" class="form-control form-control-sm radio-field">
                    </div>
