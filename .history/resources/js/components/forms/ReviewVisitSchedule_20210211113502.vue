              ...
              <div class="row pt-3 pb-3">
                <div class="col-2">
                  <div class="form-group row">
                    <div class="col-sm-3 radio-field">
                      <input type="radio" v-model="form.status" value="0" class="form-control form-control-sm radio-field">
                    </div>
                    <label class="col-sm-8 font-weight-bold radio-label text-primary">Accept</label>
                  </div>
                </div>
                <div class="col-2">
                  <div class="form-group row">
                    <div class="col-sm-3 radio-field">
                      <input type="radio" v-model="form.status" value="1" class="form-control form-control-sm radio-field">
                    </div>
                    <label class="col-sm-8 font-weight-bold radio-label text-warning">Back To Change</label>
                  </div>
                </div>
                <div class="col-2">
                  <div class="form-group row">
                    <div class="col-sm-3 radio-field">
                      <input type="radio" v-model="form.status" value="2" class="form-control form-control-sm radio-field">
                    </div>
                    <label class="col-sm-8 font-weight-bold radio-label text-danger">Cancel</label>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="form-check form-check-inline">
                  <input class="form-check-input form-control form-control-sm" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
