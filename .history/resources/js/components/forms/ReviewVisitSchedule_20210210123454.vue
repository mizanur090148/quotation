        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" @submit.prevent="store()">
              ...
              <div class="row p-2">
                <div class="col-2"><input type="radio" class="form-control form-control-sm"> Accept</div>
                <div class="col-2"><input type="radio" class="form-control form-control-sm"> Back to change</div>
                <div class="col-2"><input type="radio" class="form-control form-control-sm"> Cancel</div>
              </div>
