        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" @submit.prevent="store()">
              ...
              <div class="row p-2">
                <div class="col-2">Accept <input type="radio" class="form-control form-control-sm"> </div>
                <div class="col-2">Back to change<input type="radio" class="form-control form-control-sm"> </div>
                <div class="col-2">Cancel<input type="radio" class="form-control form-control-sm"> </div>
              </div>
