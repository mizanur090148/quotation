        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" @submit.prevent="store()">
              ...
              <div class="row p-2">
                <input type="radio" class="form-control form-control-sm"> Accept
                <input type="radio" class="form-control form-control-sm"> Back to change
                <input type="radio" class="form-control form-control-sm"> Cancel
              </div>
