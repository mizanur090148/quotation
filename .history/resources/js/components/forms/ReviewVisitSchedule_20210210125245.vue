              ...
              <div class="row p-2">
                <div class="col-3">
                  <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Accept</label>
                      <div class="col-sm-9">
                        <input type="checkbox" class="form-control form-control-sm" id="exampleInputUsername2" placeholder="Username">
                      </div>
                    </div>
                </div>
