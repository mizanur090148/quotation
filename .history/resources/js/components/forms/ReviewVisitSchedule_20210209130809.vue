          ...
          <div class="card-body">
            ...
            <form class="forms-sample" @submit.prevent="store()">
              ...
              <div class="row p-2">
                ...
                <textarea v-model="form.admin_comment" rows="2" cols="12" class="form-control form-control-sm" :class="{ 'is-invalid': errors.note }" placeholder="Enter note"></textarea>
                  <small class="text-danger" v-if="errors.note">{{ errors.admin_comment[0] }}</small>
              </div>
