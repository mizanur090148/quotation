              ...
              <div class="row p-2">
                <div class="col-3">
                  <div class="form-group row">
                    <div class="col-sm-3 radio-field">
                      <input type="radio" class="form-control form-control-sm radio-field">
                    </div>
                ...
                <div class="col-3">
                  <div class="form-group row pt-2">
                    <label for="exampleInputUsername2" class="col-sm-3 font-weight-bold">Accept</label>
                    <div class="col-sm-2">
                      <input type="radio" class="form-control form-control-sm">
                    </div>
                  </div>
                </div>
                <div class="col-3">
