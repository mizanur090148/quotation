...
Route::get('get-products-by-category/{categoryId}', [ScheduleController::class, 'getProductsByCategory']);

Route::get('get-visit-schedule-data', [ScheduleController::class, 'getAvailableProducts']);
